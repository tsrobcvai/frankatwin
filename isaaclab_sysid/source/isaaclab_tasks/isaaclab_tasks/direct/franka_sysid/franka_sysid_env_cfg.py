...
"""Configuration for ``Isaac-FrankaTwin-Sysid-v0``.

:mod:`franka_replay_env_cfg` with the arm joints moved to
``DelayedPDActuatorCfg``, whose armature, friction and delay the fit writes per
env.
"""
