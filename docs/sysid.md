...
These are the figures the README quotes; the comparison video in the
[README](https://github.com/tsrobcvai/frankatwin#readme) shows this run — the
twin beside the real arm, with and without the identified parameters.
