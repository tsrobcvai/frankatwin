...
.. autoclass:: frankatwin.remote_client.FrankaTwinClient
   :members: set_ee_target, set_gains, enable, disable, get_state, get_state_history, wait_for_state, move_to_q, move_to_pose, close
```
...
.. autoclass:: frankatwin.local_controller.LocalController
   :members: start_controller, stop_controller, is_controller_alive, ensure_running, set_ee_target, set_gains, enable, disable, get_state, get_all_state, move_to_q, move_to_pose, close
```
